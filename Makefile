...
help:
	...
	@echo "  make prodlike-k6         # prodlike 환경에서 k6 실행"
	@echo ""
	@echo "[Cloud 환경]"
	...
	@echo ""
	@echo "[성능 테스트]"
	@echo "  make perf                                # 기본 test.js (local)"
	@echo "  make perf PERF_SCENARIO=stress            # 특정 시나리오 실행"
	@echo "  make perf PERF_SCENARIO=load ENV=cloud    # cloud 환경에서 실행"
	@echo ""
	@echo "[유틸]"

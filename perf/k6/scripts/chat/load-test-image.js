...
function createRoom(credentials) {
  const res = http.post(
    ...
    null,
    {
      ...
      tags: { scenario: 'chat_image_load', endpoint: 'chat_room_create', method: 'POST' },
    }
  );
...
function sendMessage(credentials, roomId) {
  ...
  form.append('message', `LOAD chat image message ${__VU}-${__ITER}`);
  ...
  const res = http.post(
    ...
    form.body(),
    {
      ...
      tags: { scenario: 'chat_image_load', endpoint: 'chat_send', method: 'POST' },
    }
  );
...
function getMessages(credentials, roomId) {
  const res = http.get(
    ...
    {
      headers: authHeader(credentials),
      tags: { scenario: 'chat_image_load', endpoint: 'chat_messages', method: 'GET' },
    }
  );
...
function getChatList(credentials) {
  const res = http.get(
    ...
    {
      headers: authHeader(credentials),
      tags: { scenario: 'chat_image_load', endpoint: 'chat_list', method: 'GET' },
    }
  );

...
//
//        Mockito.`when`(
//            searchService.searchUnifiedListCursor(
//                keyword = "노트북",
//                sort = "relevance",
//                size = 20,
//                cursor = null
...
//
//        Mockito.`when`(
//            searchService.searchUnifiedListCursor("노트북", "relevance", 1, null)
//        ).thenReturn(empty1)
//
...
//
//        Mockito.`when`(
//            searchService.searchUnifiedListCursor("노트북", "relevance", 50, null)
//        ).thenReturn(empty50)
//
//        val rs2 = controller.search(keyword = "노트북", sort = "relevance", size = 999, cursor = null)
//        assertThat(rs2.data!!.size).isEqualTo(50)
//
//        Mockito.verify(searchService).searchUnifiedListCursor("노트북", "relevance", 1, null)
//        Mockito.verify(searchService).searchUnifiedListCursor("노트북", "relevance", 50, null)
//    }
//
//    @Test
...
//
//        Mockito.`when`(
//            searchService.searchUnifiedListCursor("노트북", "relevance", 20, null)
//        ).thenReturn(result)
//
//        controller.search(keyword = "노트북", sort = "WeIrD", size = 20, cursor = null)
//
//        Mockito.verify(searchService).searchUnifiedListCursor("노트북", "relevance", 20, null)
//    }
//
//    @Test
...
//
//        Mockito.`when`(
//            searchService.searchUnifiedListCursor("노트북", "newest", 10, "CURSOR123")
//        ).thenReturn(result)
//
//        val rs = controller.search(keyword = "노트북", sort = "newest", size = 10, cursor = "CURSOR123")
//
//        Mockito.verify(searchService).searchUnifiedListCursor("노트북", "newest", 10, "CURSOR123")
